...
import static com.example.mitlab_raymond.copdhealthcare.DeviceActivity.lastLeftDevice;
import static com.example.mitlab_raymond.copdhealthcare.Model.GattAttributes.CLIENT_CHARACTERISTIC_CONFIG_NEW;
import static com.example.mitlab_raymond.copdhealthcare.Model.GattAttributes.CLIENT_CHARACTERISTIC_CONFIG_ZOE;
import static com.example.mitlab_raymond.copdhealthcare.Model.GattAttributes.Characterstic_SPO2_UUID;
import static com.example.mitlab_raymond.copdhealthcare.Model.GattAttributes.UUID_DATA_READ;
import static com.example.mitlab_raymond.copdhealthcare.Model.GattAttributes.UUID_SERVICE_SPO2_wrist;
import static com.example.mitlab_raymond.copdhealthcare.Model.GattAttributes.UUID_SERVICE_ZOE;
...
//            Log.d("onCharacteristicChanged", String.format("Device:%s , Data: %s \n-----------------",addr,data));
    ...
    public boolean connectGatt(final String address) throws MyException
    {
        ...
        if(bleGatts.get(address)==null){
            ...
            BluetoothGatt bleGatt = device.connectGatt(this, true, mGattCallback);
            if(bleGatt!=null){
                bleGatts.put(address,bleGatt);
            }else
                throw new MyException(BT_CONNECTED_FAIL);
        }else{
                throw new MyException(BT_IS_CONNECTED);
        }
        return true;
    }
